...
<c:import url="/WEB-INF/views/include/header.jsp" />
  ...
  <div class="container mt-5">
    <div class="row justify-content-center">
		<div class="col-md-6">
			<button type="button" class="btn btn-primary btn-lg" style="width: 100%; background-color: #85BCEB; font-weight: bold; margin-top: 20px; border: none;" onclick="location.href='${root}/pro/expert'">저장하기</button>
      	</div>
    </div>
  </div>
