...
<script>
	...
	$(document).ready(function() {
	  $('.portDel').click(function() {
	    ...
	    // 이곳에 Ajax 호출 등을 넣을 수 있습니다.
	  });
	
	  $('.portComp').click(function() {
	    var portfolioId = $(this).data('id');
	    console.log('Complete button clicked for portfolio ID:', portfolioId);
	    // 이곳에 Ajax 호출 등을 넣을 수 있습니다.
	  });
	}); 
</script>
									...
									<div class="modal-dialog modal-dialog-scrollable modal-lg">
										<div class="modal-content">
											...
											<div class="modal-footer">
												<button type="button" class="btn btn-secondary portDel" data-bs-dismiss="modal" data-id="${portfolio.portfolio_id}">삭제</button>
												<button type="button" class="btn btn-primary portComp" data-bs-dismiss="modal" data-id="${portfolio.portfolio_id}">검수 완료</button>
											</div>
										</div>
									</div>
								</div>
