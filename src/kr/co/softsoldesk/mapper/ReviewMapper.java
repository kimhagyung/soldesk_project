...
public interface ReviewMapper {
	...
	@Insert("insert into review(review_id, pro_id, user_id,  review_contents, rating, photos, review_date) "
			+ "values(review_seq.nextval, #{pro_id, jdbcType=INTEGER, javaType=Integer}, #{user_id, jdbcType=INTEGER, javaType=Integer}, #{review_contents}, #{rating}, #{photos, jdbcType=VARCHAR}, sysdate)")
