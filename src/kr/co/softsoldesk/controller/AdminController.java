...
public class AdminController {
	...
	/*
	 * @PostMapping("/adminLogin_pro") public String
	 * adminLogin_pro(@ModelAttribute("adminTempLoginBean") AdminBean
	 * adminTempLoginBean) {
	 * 
	 * try { adminService.getLoginadminInfo(adminTempLoginBean);
	 * System.out.println("AdminController-getUser_name:"+adminTempLoginBean.
	 * getAdmin_id()); if(AdminloginBean.isAdminLogin() == true) { return
	 * "admin/login_succes"; }else { return "admin/login_fail"; } }catch
	 * (NullPointerException e) { e.printStackTrace(); // NullPointerException이 발생하면
	 * 로그인 실패로 처리 return "admin/login_fail"; } }
	 */
